...
- `@deepseek-ai/dsh-experimental-client-ui-automation`（[`packages/experimental/client-ui-automation/src/index.ts`](../packages/experimental/client-ui-automation/src/index.ts)）
