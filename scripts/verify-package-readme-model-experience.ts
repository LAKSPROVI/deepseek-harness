...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-voice-input': { kind: 'none', reason: 'Browser-side push-to-talk control; the audio stays transient and only the transcript the human sends reaches a model, through the ordinary user-message path.' },
