...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SaveFileAttachmentStream: 'attachment.md',
  SaveImageAttachment: 'attachment.md',
  StoredFileAttachment: 'attachment.md',
  StoredFileAttachmentStream: 'attachment.md',
  StoredImageAttachment: 'attachment.md',
  UploadedFileAttachment: 'attachment.md',
  EncodedCommandAttachment: 'commands.md',
  ...
  GuideTeamMemberRemoteRequest: 'agent-team.md',
  SendTeamMessageRequest: 'agent-team.md',
  SendTeamMessageResult: 'agent-team.md',
  SpawnTeamMemberRemoteRequest: 'agent-team.md',
  SpawnTeammateRequest: 'agent-team.md',
  SpawnTeammateResult: 'agent-team.md',
  StartTeamDebateRequest: 'agent-team.md',
  TeamDebateSnapshot: 'agent-team.md',
  ...
  UpdateTeamDebateRequest: 'agent-team.md',
