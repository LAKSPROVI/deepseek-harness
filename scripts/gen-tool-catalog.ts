...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  },
  {
    ...
    scope: ctx => catalogChildScopes.get(ctx) as Agent,
    note:
      'All Team tools are scoped to implicit Team Leads and durable teammates. The shipped dsh-base bundle keeps the package disabled; the `agent-teams` preset enables it while disabling the legacy continuable-child control names.',
  },
  {
