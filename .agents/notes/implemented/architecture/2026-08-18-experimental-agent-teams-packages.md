...
`packages/agent-team/agent-team`, `packages/agent-team/tool-agent-team`, `packages/experimental/agent-team-profile`, `packages/client/ui-agent-team`, and `packages/experimental/agent-team-web-profile` are private workspace packages. The [experimental package rules](../../../../packages/experimental/AGENTS.md) own their npm names and promotion rename; this note owns their placement, release exclusion, and dependency isolation.
