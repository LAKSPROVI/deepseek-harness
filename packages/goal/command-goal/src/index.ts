...
/**
 * Submit the invocation's admitted composer attachments as one model-visible
 * user message ahead of the goal's next round. The attachments precede a fixed
 * text block naming their role, so a later goal round reads them from ordinary
