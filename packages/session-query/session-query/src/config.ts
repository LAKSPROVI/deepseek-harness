...
export const SESSION_QUERY_DEFAULT_PREPARED_SESSION_CACHE_SIZE = 1
...
export interface Config {
   ...
   * against this bound until released. Defaults to 1 because each entry retains
   * one complete restored log.
   */
