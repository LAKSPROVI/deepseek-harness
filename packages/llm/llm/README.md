...
- **Inspect and trigger 9Router model catalog synchronization** — `routerSyncStatus()` and `triggerRouterSync()` expose live 9Router models synchronization telemetry, route counts, and execution triggers across the Typert Remote boundary.
