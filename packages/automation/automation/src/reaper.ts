...
export class StaleTaskReaper {
  ...
  /** Reap once immediately, then on every check interval; idempotent. */
  public start(): void {
  ...
  /** Stop the periodic sweep; a sweep already in flight completes. */
  public stop(): void {
   ...
   * @param customThresholdMs - staleness threshold for this sweep; defaults to the constructor value.
