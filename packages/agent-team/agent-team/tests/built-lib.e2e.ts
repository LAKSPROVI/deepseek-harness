...
const requiredArtifacts = [
  'packages/agent-team/agent-team/lib/index.js',
  'packages/agent-team/agent-team/lib/typert.remote-client.js',
...
describe.skipIf(!requiredArtifacts)('Agent Teams built LIB service', () => {
  it('loads the Host service and its generated browser contribution under plain Node', async () => {
    const urls = {
      host: artifactUrl('packages/agent-team/agent-team/lib/index.js'),
      remote: artifactUrl('packages/agent-team/agent-team/lib/typert.remote-client.js'),
    }
    const script = `
    ...
    expect(output).toEqual({
      ...
      methods: [
        '@deepseek-ai/dsh-agent-team#agentTeams/createTask',
        '@deepseek-ai/dsh-agent-team#agentTeams/updateTask',
        '@deepseek-ai/dsh-agent-team#agentTeams/view',
      ],
    })
  })
})
