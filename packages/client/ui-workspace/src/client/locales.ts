...
export const en = {
  ...
  'status.waitingDecision': 'Waiting for decision',
  'status.setOngoing': 'In progress',
  'status.setWaitingDecision': 'Waiting for decision',
  'status.setUnread': 'Unread',
  'status.setCompleted': 'Completed',
  'status.clearStatus': 'Clear status / Idle',
