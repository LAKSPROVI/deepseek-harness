...
export const en = {
  ...
  routerSyncTitle: '9Router dynamic synchronization',
  routerSyncOperational: 'Synchronized',
  routerSyncStale: 'Needs update',
  routerSyncFailed: 'Sync failed',
  routerSyncLastSync: 'Last sync: {time}',
  routerSyncMonitorUpdate: 'Monitor update: {time}',
  routerSyncActiveModels: '{chat} active chat models ({available} available of {total} routes)',
  routerSyncTrigger: 'Sync now',
  routerSyncBusy: 'Syncing…',
  routerSyncStaleWarning: 'The local catalog was synchronized over 24 hours ago.',
  routerSyncVisionBadge: '{count} vision',
  routerSyncReasoningBadge: '{count} reasoning',
  routerSyncLatencyBadge: '{latency}s avg latency',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  routerSyncTitle: '9Router 动态模型同步',
  routerSyncOperational: '已同步',
  routerSyncStale: '待更新',
  routerSyncFailed: '同步失败',
  routerSyncLastSync: '上次同步：{time}',
  routerSyncMonitorUpdate: '监控更新：{time}',
  routerSyncActiveModels: '{chat} 个活跃对话模型（{total} 条路由中 {available} 条可用）',
  routerSyncTrigger: '立即同步',
  routerSyncBusy: '正在同步…',
  routerSyncStaleWarning: '本地模型目录已超过 24 小时未同步。',
  routerSyncVisionBadge: '{count} 个视觉模型',
  routerSyncReasoningBadge: '{count} 个推理模型',
  routerSyncLatencyBadge: '平均延迟 {latency}s',
}
