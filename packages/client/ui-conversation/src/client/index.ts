...
export type { IConversation, PromptAdmissionCheck } from './service.ts'
...
export type {
  ...
  MessageAttachment, MessageAttachmentsOwnerProps, MessageAttachmentsProps, RenderMessageAttachments,
