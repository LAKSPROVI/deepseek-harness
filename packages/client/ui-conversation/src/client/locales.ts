...
export const zh = {
  ...
  'attachment.dropTitle': '将文件拖到此处即可添加',
  'attachment.dropDesc': '最多 {count} 个附件',
  'attachment.dropDescImages': '最多 {count} 张图片，每张 {size}',
  'attachment.dropDescFiles': '最多 {count} 个文件，每个 {size}',
  'attachment.dropDescMixed': '图片最多 {imageCount} 张（每张 {imageSize}），文件最多 {fileCount} 个（每个 {fileSize}）',
...
export const en = {
  ...
  'attachment.dropTitle': 'Drag files here to add them',
  'attachment.dropDesc': 'Up to {count} attachments',
  'attachment.dropDescImages': 'Up to {count} images, {size} each',
  'attachment.dropDescFiles': 'Up to {count} files, {size} each',
  'attachment.dropDescMixed': 'Up to {imageCount} images ({imageSize} each) and {fileCount} files ({fileSize} each)',
