...
- **Generic file cards carry no type identity or transfer progress** — a draft or historical file renders one document glyph regardless of its media type, and neither card shows upload or download progress; a pending download only disables its card until the browser accepts the URL.
