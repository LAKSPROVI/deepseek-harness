...
These rules supplement the [package rules](../AGENTS.md). The [stable Agent Teams decision](../../.agents/notes/implemented/feature/2026-08-30-stable-agent-teams-debate.md) records one completed promotion from this group into a product-role package.
