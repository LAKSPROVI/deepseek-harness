...
These rules supplement the [package rules](../AGENTS.md). The [Agent Teams decision](../../.agents/notes/implemented/feature/2026-08-05-agent-teams.md) illustrates how an experimental package is promoted to its stable product-role group.
